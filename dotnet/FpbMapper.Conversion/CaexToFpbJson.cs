...
public static class CaexToFpbJson
{
        ...
        List<string> warnings)
    {
        ...
        foreach (var link in processIE.InternalLink)
        {
            ...
            // Only stored layout is emitted. Links without PortCoordinate /
            // Waypoint_* data (hand-authored AML) get no visual entry; FPB.JS
            // arranges whatever lacks layout on import, and a synthesized
            // straight line here would stop it from doing so.
